...
class BoletaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boletum" do
    assert_difference('Boletum.count') do
      post boleta_url, params: { boletum: { descuento: @boletum.descuento, fecha: @boletum.fecha, monto: @boletum.monto, pedido_id: @boletum.pedido_id } }
    end
  ...
  test "should update boletum" do
    patch boletum_url(@boletum), params: { boletum: { descuento: @boletum.descuento, fecha: @boletum.fecha, monto: @boletum.monto, pedido_id: @boletum.pedido_id } }
